 ...
 * CIS*2750F13 (prototypes/data definitions).
 *
 * @author   David McCaughan
 * @version  1.2b, 2013/11/25
 *
 */
...
/*
 * Basic Codemon parameters (A4 - final : not all are necessarily relevant
 * to the client-side, but here you go)
 ...
 * - memory has 4096 locations (all values are integers between 0 and 4095)
